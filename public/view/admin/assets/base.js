...
var apiAdminDelete = '/api/admin/delete';//删除管理员
var apiAdminAdd = '/api/admin/add';//添加管理员
var apiAdminEdit = '/api/admin/edit';//添加管理员
...
var apiOrderEdit = '/api/order/edit';//编辑订单
var apiOrderDelete = '/api/order/delete';//删除订单
